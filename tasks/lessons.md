...
- A browser may coalesce one isolated decoded-frame callback even at reduced playback speed. Arrival continuity gates should require full first/last authored coverage, monotonic samples, no repeat or multi-frame gap, exact camera parity, and a pixel-stable endpoint handoff; normal-speed review film remains the motion-quality proof.
